...
const offersApiURL = "http://localhost:7022";
const requestsApiURL = "http://localhost:7023";
const identityApiURL = "http://localhost:7021";

const postOfferURL = offersApiURL + "/api/offers";
const getOfferURL = offersApiURL + "/api/offers";
const acceptOfferURL = offersApiURL + "/api/offers/accept";
const getOfferByIdURL = offersApiURL + "/api/offer-details";

const getRequestURL = requestsApiURL + "/api/requests";
const postRequestURL = requestsApiURL + "/api/requests";
const acceptRequestURL = requestsApiURL + "/api/requests/accept";
const getRequestByIdURL = requestsApiURL + "/api/request-details";
...
const appendValidationBody = (body) => ({
	...body,
